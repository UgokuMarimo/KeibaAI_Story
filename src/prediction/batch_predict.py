...
def batch_predict(target_date: str = None, race_ids: list = None, run_shap: bool = True, use_overseas: bool = False, enable_explanation: bool = False, send_discord: bool = True):
    """
    複数レースを一括予測する関数。
    """
    print(f"--- [START] Batch Prediction ---")
...
if __name__ == "__main__":
    ...
    parser.set_defaults(run_shap=True, use_overseas=False, enable_explanation=False, send_discord=True)
